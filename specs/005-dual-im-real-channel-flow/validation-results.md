...
- 脱敏截图索引：
  - `C:\Users\admin\AppData\Local\Temp\codex-clipboard-593d8f78-065e-4d94-93d4-6c0a7bfa4f4c.png`：群聊未 `@`、保存、召回结果。
  - `C:\Users\admin\AppData\Local\Temp\codex-clipboard-27ac5efa-5c3b-4b8d-92d2-336a969f5f50.png`：第二用户召回返回 `context-missing`。
  - `C:\Users\admin\AppData\Local\Temp\codex-clipboard-03950aec-22e4-4308-b410-7ccb5acabbe7.png`：应用测试企业/人员配置界面。
  - `C:\Users\admin\AppData\Local\Temp\codex-clipboard-1643f1ba-4083-49af-9e8b-dfcd4caef338.png`：外部群限制提示（环境限制，不作为通过证据）。
  - `C:\Users\admin\AppData\Local\Temp\codex-clipboard-5b7bfda9-cb7d-4b8d-92b5-33789e773b03.png`：外部群限制提示（环境限制，不作为通过证据）。
...
- 脱敏截图索引：
  - `C:\Users\admin\AppData\Local\Temp\codex-clipboard-c434ec99-b650-4c8a-8fa5-72716dad26fa.png`：
    企业微信单聊首轮回复和脱敏 `reply_delivered` 日志。
  - `C:\Users\admin\AppData\Local\Temp\codex-clipboard-40784f62-0180-4276-bea8-9f7b9fe64c9f.png`：
    企业微信群聊保存、召回和脱敏投递日志。
...
- `wecom-b` 日志先显示 `standby`，随后完成 WebSocket 认证并输出
  ...
  已完成接管。
- 脱敏截图索引：
  - `C:\Users\admin\AppData\Local\Temp\codex-clipboard-c1ffa943-490e-412f-8c71-31318aa8b683.png`：
    接管前后 readiness、owner 和 generation 查询结果。
  - `C:\Users\admin\AppData\Local\Temp\codex-clipboard-12d8d15f-7e7f-4403-b2d3-31cf38e17e5a.png`：
    `wecom-b` 从 standby 到 ready 的认证日志。
